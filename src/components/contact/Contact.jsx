...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_2zmmk19", "template_u7icxmu", form.current, {
        publicKey: "Qw5PwZbTcKDthxZo1",
      })
      .then(
        () => {
          setMessageSent(true); // Set state to true on success
          setTimeout(() => setMessageSent(false), 3000); // Hide notification after 3 seconds
        },
        (error) => {
  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        ...
        <div className="contact__content">
          <h3 className="contact__card-title">Write me your project</h3>
